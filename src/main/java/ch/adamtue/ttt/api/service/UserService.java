...
public class UserService {
		...
		throws FailedPasswordHashException, InvalidCredentialsException
	{
		 ...
		 */
		if (ul.isPasswordChangeOnLogin() && !ul.getPasswordResetValue().equals(loginInfo.getPassword())) {
	...
	{
		this.dbService.changeUserRole(request);

		return new ChangeUserRoleResponse(request);
	}
}
